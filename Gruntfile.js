module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        uglify: {
            ...
            amd: {
                src: 'dist/davinci-csv.js',
                dest: 'dist/davinci-csv.min.js'
            },
            system: {
                src: 'dist/davinci-csv-system-es5.js',
                dest: 'dist/davinci-csv-system-es5.min.js'
            }
        },
    ...
    function bundle() {
        ...
        return builder.bundle('davinci-csv.js', 'dist/davinci-csv-system-es5.js', options);
    }
